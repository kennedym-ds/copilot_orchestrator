...
### Model Updates
- Premium tier: Claude Sonnet 4.6 → Claude Haiku 4.5 → GPT-4.1
- Execution tier: Claude Haiku 4.5 → Claude Haiku 4.5 → GPT-4.1
- Fast tier: Claude Haiku 4.5 → GPT-5 mini → Claude Haiku 4.5
...
- **Model Allocation**: Updated model tiers — Premium (Sonnet 4.6, Haiku 4.5), Execution (GPT-5.3-Codex, Haiku 4.5), Routine (Haiku 4.5, Gemini 3 Flash)
