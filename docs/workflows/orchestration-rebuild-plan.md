...
- **Responsibilities:**
  - Invoke specialized custom agents via `#runSubagent` with bounded prompts and toolsets.
...
- **Model:** Default to Claude Opus 4.6 for reasoning; allow overrides via front matter.
