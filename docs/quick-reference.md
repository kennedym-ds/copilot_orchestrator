...
|------|---------------------|--------------|----------------|
| **Premium (security-only)** | GPT-5.3-Codex -> GPT-5.3-Codex | <5% (security review only) | high |
| **Execution** | GPT-5.3-Codex -> GPT-5.4 mini -> GPT-5.3-Codex | ~81% (13 agents) | low / medium / high |
