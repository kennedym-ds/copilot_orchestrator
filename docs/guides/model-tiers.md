...
|------------|--------|
| **3×** | GPT-5 mini |
| **1×** | GPT-5 mini, GPT-5 mini |
| **0.33×** | GPT-4.1, Gemini 3 Flash, GPT-5.1-Codex-Mini |
...
### Execution — GPT-5 mini (1×)

The workhorse tier. GPT-5 mini was selected over GPT-5 mini because it scores higher on every benchmark at the same 1× cost, with a 1M token context window:

| Benchmark | GPT-5 mini | GPT-5 mini |
|-----------|---------|---------------|
...
| **Beast Mode** | Extended reasoning with visible thinking. GPT-5 mini provides sufficient depth at 1× vs Opus at 3×. |
...
| **Docs** | Documentation generation needs 1M context window to process entire documentation trees. Previously Haiku; upgraded to GPT-5 mini specifically for the 5× larger context window. |
...
| Agent | Rationale |
|-------|-----------|
| **Translation Conductor** | Orchestrates the 6-phase translation lifecycle across 4 sub-agents. Uses GPT-5 mini (not GPT-5 mini) because it leverages Anthropic-specific tool-use patterns and `agents:` allowlist features that work best within the Claude model family. |

### Routine — GPT-4.1 (0.33×)
...
|------------|---------------------|---------|
| GPT-5 mini (3×) | GPT-5 mini (1×) | 67% per request |
| GPT-5 mini (1×) | GPT-4.1 (0.33×) | 67% per request |
| GPT-5 mini (1×) | GPT-4.1 (0.33×) | 67% per request |
| GPT-4.1 (0.33×) | GPT-4.1 (0.33×) | 0% (already cheapest) |
...
**Result:** 3 agents on GPT-5 mini, 26 on GPT-4.1.
...
|------|---------|------------|------------|
| Premium | GPT-5 mini | GPT-5 mini | GPT-5 mini |
| Execution (GPT) | GPT-5 mini | GPT-5 mini | GPT-4.1 |
| Execution (Claude) | GPT-5 mini | GPT-5 mini | GPT-4.1 |
| Routine | GPT-4.1 | GPT-5.1-Codex-Mini | Gemini 3 Flash |
...
|------|----------|-------------|------|----------|
| Premium | GPT-5 mini | 3 (~10%) | 3× | Orchestration, planning, security |
| Execution | GPT-5 mini, GPT-5 mini | 23 (~80%) | 1× | Implementation, review, analysis, translation |
| Routine | GPT-4.1 | 3 (~10%) | 0.33× | Formatting, questions, diagrams |
