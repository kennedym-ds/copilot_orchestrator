...
4. Verify agents loaded: Right-click in Chat → **Diagnostics** — all 28 agents should appear
...
All 28 agents in this repo now use model fallback arrays for resilience.
