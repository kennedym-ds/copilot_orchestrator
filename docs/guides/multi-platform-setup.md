...
|--------------|-------------------|
| `Claude Sonnet 4.6 (copilot)` | `opus` |
| `Claude Haiku 4.5 (copilot)` | `sonnet` |
| `Claude Haiku 4.5 (copilot)` | `haiku` |
| `Claude Haiku 4.5 (copilot)` | `sonnet` (fallback) |
...
| `Claude Haiku 4.5 (copilot)` | `inherit` (uses IDE default) |
