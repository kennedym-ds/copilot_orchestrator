...
This document defines triggers and patterns for escalating from execution-tier models (GPT-5.3-Codex, GPT-5.3-Codex) to security-only premium review (GPT-5.3-Codex/4.7) during implementation phases. Escalation preserves cost efficiency while ensuring security risks receive the deepest review when warranted.
...
- Default models: GPT-5.3-Codex, GPT-5.3-Codex
...
- Premium models: GPT-5.3-Codex / 4.7 (reviewer --security prompt override)
