...
This document defines triggers and patterns for escalating from cost-efficient models (GPT-5.3-Codex, Claude Haiku 4.5) to premium reasoning models (Claude Sonnet 4.6, Claude Haiku 4.5, GPT-5.3-Codex) during implementation phases. Escalation preserves cost efficiency while ensuring quality recovery when complexity exceeds the capabilities of execution-tier models.
...
- Default models: GPT-5.3-Codex, Claude Haiku 4.5
...
- Premium models: Claude Sonnet 4.6, Claude Haiku 4.5, GPT-5.3-Codex
...
3. **Premium model escalation:**
   - Larger context windows (Claude Haiku 4.5: 200K, Claude Sonnet 4.6: 200K)
