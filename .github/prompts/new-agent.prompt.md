...
- Premium (~15%): Orchestration, planning, review → Claude Sonnet 4.6 → Claude Haiku 4.5 → GPT-4.1
- Execution (~75%): Implementation, testing, analysis → Claude Haiku 4.5 → Claude Haiku 4.5 → GPT-4.1
- Fast (~10%): Documentation, UX → Claude Haiku 4.5 → GPT-5 mini → Claude Haiku 4.5
