...
1. **Inspect Context:** Read at least 2,000 surrounding lines for each target file using `read`, `fileSearch`, or `githubRepo` to understand dependencies and invariants.
