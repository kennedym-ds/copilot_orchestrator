...
- New premium-tier agent (GPT-5.3-Codex / GPT-5.3-Codex) with 3 complexity tiers (LIGHTWEIGHT, STANDARD, COMPREHENSIVE)
...
- Premium (~20%): GPT-5.3-Codex, GPT-5.3-Codex → conductor, planner, reviewer, security, beast-mode, researcher
- Execution (~70%): GPT-5.3-Codex, GPT-5.3-Codex → implementer, test, red-team, performance, data-analytics, accessibility, observability, visualizer, deployment, github-ops, maintainer, terraform, bicep, design
- Routine (~10%): GPT-5.3-Codex → docs, lint
...
- Added: `github.copilot.chat.implementAgent.model: "GPT-5.3-Codex (copilot)"`
