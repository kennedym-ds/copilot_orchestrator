...
- New premium-tier agent (Claude Sonnet 4.6 / Haiku 4.5) with 3 complexity tiers (LIGHTWEIGHT, STANDARD, COMPREHENSIVE)
...
- Premium (~20%): Claude Sonnet 4.6, Claude Haiku 4.5 → conductor, planner, reviewer, security, beast-mode, researcher
- Execution (~70%): Claude Haiku 4.5, GPT-5.3-Codex → implementer, test, red-team, performance, data-analytics, accessibility, observability, visualizer, deployment, github-ops, maintainer, terraform, bicep, design
- Routine (~10%): Claude Haiku 4.5 → docs, lint
...
- Added: `github.copilot.chat.implementAgent.model: "Claude Haiku 4.5 (copilot)"`
